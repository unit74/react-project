...
router.post("/", async function(req, res){
    ...
    try {
        ...
        sql = `Insert into web_informations (EMPLOYEE_ID,WEB_ID,WEB_PW,WEB_AUTHORITY) values (${employeeId},'${webId}','${webPw}','${webAuthority}')`;
        await connection.execute(sql);
        
        res.send({complete: true, state: { isMsg: true, sendSvt: 'success', sendMsg: '추가되었습니다.', refresh: true }});
    }
    catch(e) {
        console.log(e)
    }
